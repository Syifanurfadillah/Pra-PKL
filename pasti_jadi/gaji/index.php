  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="">Data Gaji<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
        ...
        <!-- TABLE DOSEN -->
        <br>
         <center><font face="Times New Roman"><h2>Data Gaji Karyawan</h2></font></center>
         <div class="container">
           <div class="card">
             <div class="card-header">
               <h3></h3>
               <center><a href="create.php" class="btn btn-primary"><font face="Times New Roman">Tambah Data Karyawan</font></a></center>
             </div>
             <div class="card-body">
